...
4. Write a function that takes a data frame as its input and returns a data frame with only the numeric columns. Test that it works with the `forcats::gss_cat` dataset. Do not use `dplyr::select()` or its helpers.
